...
@AndroidEntryPoint
class PopularExpSpainTwoFragment : Fragment() {
    lateinit var binding : FragmentPopularExpSpainTwoBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPopularExpSpainTwoBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ivF29.setOnClickListener {
            val spain: String = binding.tvE29.text.toString()
        ...
        binding.ivF30.setOnClickListener {
            val spain: String = binding.tvE30.text.toString()
        ...
        binding.ivF31.setOnClickListener {
            val spain: String = binding.tvE31.text.toString()
        ...
        binding.ivF32.setOnClickListener {
            val spain: String = binding.tvE32.text.toString()
        ...
        binding.ivF33.setOnClickListener {
            val spain: String = binding.tvE33.text.toString()
        ...
        binding.ivF34.setOnClickListener {
            val spain: String = binding.tvE34.text.toString()
        ...
        binding.ivF35.setOnClickListener {
            val spain: String = binding.tvE35.text.toString()
        ...
        binding.ivF36.setOnClickListener {
            val spain: String = binding.tvE36.text.toString()
        ...
        binding.ivF37.setOnClickListener {
            val spain: String = binding.tvE37.text.toString()
        ...
        binding.ivF38.setOnClickListener {
            val spain: String = binding.tvE38.text.toString()
        ...
        binding.ivF39.setOnClickListener {
            val spain: String = binding.tvE39.text.toString()
        ...
        binding.ivF40.setOnClickListener {
            val spain: String = binding.tvE40.text.toString()
        ...
        binding.ivF41.setOnClickListener {
            val spain: String = binding.tvE41.text.toString()
        ...
        binding.ivF42.setOnClickListener {
            val spain: String = binding.tvE42.text.toString()
        ...
        binding.ivF43.setOnClickListener {
            val spain: String = binding.tvE43.text.toString()
        ...
        binding.ivF44.setOnClickListener {
            val spain: String = binding.tvE44.text.toString()
        ...
        binding.ivF45.setOnClickListener {
            val spain: String = binding.tvE45.text.toString()
        ...
        binding.ivF46.setOnClickListener {
            val spain: String = binding.tvE46.text.toString()
        ...
        binding.ivF47.setOnClickListener {
            val spain: String = binding.tvE47.text.toString()
        ...
        binding.ivF48.setOnClickListener {
            val spain: String = binding.tvE48.text.toString()
        ...
        binding.ivF49.setOnClickListener {
            val spain: String = binding.tvE49.text.toString()
        ...
        binding.ivF50.setOnClickListener {
            val spain: String = binding.tvE50.text.toString()
        ...
        binding.ivF51.setOnClickListener {
            val spain: String = binding.tvE51.text.toString()
        ...
        binding.ivF52.setOnClickListener {
            val spain: String = binding.tvE52.text.toString()
        ...
        binding.ivF53.setOnClickListener {
            val spain: String = binding.tvE53.text.toString()
        ...
        binding.ivF54.setOnClickListener {
            val spain: String = binding.tvE54.text.toString()
        ...
        binding.ivF55.setOnClickListener {
            val spain: String = binding.tvE55.text.toString()
        ...
        binding.ivF56.setOnClickListener {
            val spain: String = binding.tvE56.text.toString()
