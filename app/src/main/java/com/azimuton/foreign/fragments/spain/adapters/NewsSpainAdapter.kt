...
class NewsSpainAdapter(private val contextA: Context, private val listNews: List<Article>,
                       val mItemClickListener: ItemClickListener
)  : RecyclerView.Adapter<NewsSpainAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(listNews[position].urlToImage != null){
            Glide.with(contextA)
    ...
    interface  ItemClickListener{
        ...
        fun details(position: Int, listNews: List<Article>)
    }
